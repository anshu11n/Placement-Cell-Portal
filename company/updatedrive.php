                            ...
                            <div class="row">
                                <form action="updatedrive1.php" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                            ...
                                            <div class="col-md-6 latest-job ">
                                                <div class="form-group">
                                                    <label for="contactno">Eligibility / Minimum Marks</label>
                                                    <input type="text" class="form-control input-lg" id="Eligibility" name="Eligibility" placeholder="Minimum Marks" value="<?php echo $row['minimummarks']; ?>">
                                                </div>
                                                <div class="form-group">
